...
public class TargetLog {
	...
	public TargetLog(jp.engawa.ondo.entity.OdTargetLogEntity en, Db db) throws SQLException {
	...
	public String getCur_tmpStr() {
		return new DecimalFormat("0.00").format(this.cur_tmp);
	}
